...
>
  ...
  <g id="Layer_1-2" data-name="Layer_1">
    ...
    />
    <path
      className={`cls-1 text-${rocketColor}`}
      d="M207.26,49.8c-.83-3.54-1.29-13.76-1.29-18.02,0-11.89,7.44-30.45,7.76-31.24.13-.32.45-.54.8-.54s.67.22.8.54c.32.79,7.76,19.35,7.76,31.24,0,4.26-.45,14.48-1.29,18.02-.09.39-.44.66-.84.66h-12.86c-.4,0-.75-.27-.84-.66Z"
    />
    <path
      className={`text-${rocketColor}`}
...
<div className={`absolute h-2 w-full bottom-0 bg-${smokeColor}`}></div></>
  )
}
