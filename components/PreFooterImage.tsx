...
const PreFooterImage = () => {
  return (
    <div className="pt-8  overflow-hidden relative">
              <div className="absolute top-0 bottom-0 left-0 right-0 w-full  bg-gradient-to-b from-[#1E1459]/90 to-[#2B1B6D] -z-20"></div>
      ...
      <div className="absolute  top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2  animate-twinkle z-20">
        <Image
          ...
          className="absolute object-cover w-full sm:opacity-100 opacity-0 top-1/3 left-0"
        />
        <Image
          src={whiteStarPhone}
          alt="Picture white stars"
          className="absolute object-cover w-full sm:hidden  top-1/2 left-0"
        />
      </div>
      {/* ------------------ringed asteroid------------- */}
      <div>
        <Image
          src={asteroidRinged}
          alt="Asteroid"
          className="absolute right-[45%] z-30 bottom-0 animate-float opacity-80 w-24  lg:w-40 object-cover"
        ></Image>
      </div>
      {/* ------------------deep blue planet------------- */}
      <div>
        <Image
          src={deepBluePlanet}
          alt="Asteroid"
          className="absolute left-1/4 z-30 top-10 animate-spin-slow-ccw opacity-80 w-12 lg:w-24 object-cover"
        ></Image>
      </div>
      {/* ------------------red blue planet------------- */}
      <div>
