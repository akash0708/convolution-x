  ...
  return (
    ...
    to-[#3AADD9] -z-20"
      ...
      <div className="maxWidthForSections flex flex-col items-center">
        <div
          className={`rounded-xl py-12 px-8 bg-gradient-to-l from-white/20 to-white/5 backdrop-filter backdrop-blur-sm relative shadow-black/10 shadow-md `}
        >
          {/* ----------------------pendant hanging-------------------------- */}
          <Image
        src={pendant1}
        className="absolute top-0 left-[10%] w-10 h-auto"
        alt="trees"
      />
       <Image
        src={pendant2}
        className="absolute top-0 left-[17.5%] w-10 h-auto"
        alt="trees"
      />
       <Image
        src={pendant3}
        className="absolute top-0 left-[25%] w-10 h-auto"
        alt="trees"
      />
      <Image
        src={pendant1}
        className="absolute top-0 right-[10%] w-10 h-auto"
        alt="trees"
      />
       <Image
        src={pendant2}
        className="absolute top-0 right-[17.5%] w-10 h-auto"
        alt="trees"
      />
       <Image
        src={pendant3}
        className="absolute top-0 right-[25%] w-10 h-auto"
        alt="trees"
      />
          <h1 className="uppercase text-center text-4xl mb-8 text-white text-shadow-dark">
            Rules & Regulations
          </h1>
          <ul className="space-y-3 list-disc list-inside">
            {sparkhackRules.map((rule, index) => {
              return (
                <li
                  key={`rule` + index}
                  className="text-white text-xl text-shadow-dark "
                >
                  {rule}
                </li>
              );
        ...
        <button className="mt-4 self-center py-2 px-8 rounded-full bg-[#3AADD9] shadow-white/80 hover:shadow-white/40 shadow-md text-white hover:opacity-100 opacity-80 transition-all duration-300 ">
