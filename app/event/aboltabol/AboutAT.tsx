    ...
    >
     ...
     to-[#010A5F] -z-20"
      ...
      <div className="maxWidthForSections flex flex-col items-center">
        ...
        <a href="https://drive.google.com/file/d/1P9kAtLRj4-xobBpuIdfCKmjOUKcByUpJ/view" target="_blank" className="mt-4 self-center py-2 sm:px-8 px-6 sm:text-xl rounded-full    shadow-md text-white  transition-all duration-300 shadow-white/70 hover:shadow-white/30  bg-[#0212B4] hover:bg-white  hover:text-[#0212B4] text-[#ffff]">
