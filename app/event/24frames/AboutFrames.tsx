  ...
  return (
    ...
    >
      ...
      <div className="maxWidthForSections flex flex-col items-center">
        ...
        <a href="https://drive.google.com/file/d/1vtp5zcnHud0yVoRZ2N86ZcwjpU32OtGY/view?usp=sharing" target="_blank" className="mt-4 self-center py-2 sm:px-8 px-6 sm:text-xl rounded-full hover:bg-[#ffff] text-[#1BA0E8]  shadow-[#ffff] hover:shadow-[#fff]/90 bg-white hover:opacity-80  transition-all duration-300 ">
