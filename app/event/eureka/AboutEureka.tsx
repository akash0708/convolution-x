...
const rulesDecisia = [
  ...
  "For the Final Round, contestants must bring at least one laptop per team (mandatory). The use of mobile phones and tablets is allowed.",
    ...
    return (
        ...
        >
          ...
          <div className="maxWidthForSections flex flex-col items-center">
            <div
              className={`rounded-xl sm:py-12 py-6 sm:px-8 px-4 bg-[#223A32]/30 backdrop-filter backdrop-blur-sm relative shadow-black/20 shadow-md `}
            >
